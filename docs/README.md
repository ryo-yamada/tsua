...
Some notes:
- Know some decent English. Typos and such, I can fix. Text I can't understand, not so much.
- Please don't modify the files in the `style/` folder.
- Please do not just copy parts the project README and paste them into the documentation. It's supposed to serve as more detailed explanation on tsua's features.
